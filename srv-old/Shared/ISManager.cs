...
public class ISManager : InterServerChannel, IDisposable
{
    ...
    private const int PingPeriod = 2000 * 1000;
    private const int ServerTimeout = 30000 * 1000;
    ...
    private readonly Dictionary<string, long> _lastUpdateTime =
        new();
    ...
    public void Tick(long elapsedUs)
    {
        lock (_dicLock)
        {
            // update running time
