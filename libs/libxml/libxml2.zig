...
const srcs = &.{
    relDir() ++ "/libxml2/buf.c",
    relDir() ++ "/libxml2/c14n.c",
    relDir() ++ "/libxml2/catalog.c",
    relDir() ++ "/libxml2/chvalid.c",
    relDir() ++ "/libxml2/debugXML.c",
    relDir() ++ "/libxml2/dict.c",
    relDir() ++ "/libxml2/encoding.c",
    relDir() ++ "/libxml2/entities.c",
    relDir() ++ "/libxml2/error.c",
    relDir() ++ "/libxml2/globals.c",
    relDir() ++ "/libxml2/hash.c",
    relDir() ++ "/libxml2/HTMLparser.c",
    relDir() ++ "/libxml2/HTMLtree.c",
    relDir() ++ "/libxml2/legacy.c",
    relDir() ++ "/libxml2/list.c",
    relDir() ++ "/libxml2/nanoftp.c",
    relDir() ++ "/libxml2/nanohttp.c",
    relDir() ++ "/libxml2/parser.c",
    relDir() ++ "/libxml2/parserInternals.c",
    relDir() ++ "/libxml2/pattern.c",
    relDir() ++ "/libxml2/relaxng.c",
    relDir() ++ "/libxml2/SAX.c",
    relDir() ++ "/libxml2/SAX2.c",
    relDir() ++ "/libxml2/schematron.c",
    relDir() ++ "/libxml2/threads.c",
    relDir() ++ "/libxml2/tree.c",
    relDir() ++ "/libxml2/uri.c",
    relDir() ++ "/libxml2/valid.c",
    relDir() ++ "/libxml2/xinclude.c",
    relDir() ++ "/libxml2/xlink.c",
    relDir() ++ "/libxml2/xmlIO.c",
    relDir() ++ "/libxml2/xmlmemory.c",
    relDir() ++ "/libxml2/xmlmodule.c",
    relDir() ++ "/libxml2/xmlreader.c",
    relDir() ++ "/libxml2/xmlregexp.c",
    relDir() ++ "/libxml2/xmlsave.c",
    relDir() ++ "/libxml2/xmlschemas.c",
    relDir() ++ "/libxml2/xmlschemastypes.c",
    relDir() ++ "/libxml2/xmlstring.c",
    relDir() ++ "/libxml2/xmlunicode.c",
    relDir() ++ "/libxml2/xmlwriter.c",
    relDir() ++ "/libxml2/xpath.c",
    relDir() ++ "/libxml2/xpointer.c",
    relDir() ++ "/libxml2/xzlib.c",
};
