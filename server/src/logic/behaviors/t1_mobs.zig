...
pub const Crocodile = struct {
    pub const object_name = "Crocodile";
...
pub const SpikeBall = struct {
    pub const object_name = "Spike Ball";
...
pub const GoblinGrunt = struct {
    pub const object_name = "Goblin Grunt";
...
pub const GoblinGuard = struct {
    pub const object_name = "Goblin Guard";
...
pub const LivingFlame = struct {
    pub const object_name = "Living Flame";
...
pub const DemonMage = struct {
    pub const object_name = "Demon Mage";
...
pub const DemonArcher = struct {
    pub const object_name = "Demon Archer";
...
pub const JackalWarrior = struct {
    pub const object_name = "Jackal Warrior";
...
pub const JackalPriest = struct {
    pub const object_name = "Jackal Priest";
...
pub const JackalArcher = struct {
    pub const object_name = "Jackal Archer";
...
pub const RegalMummy = struct {
    pub const object_name = "Regal Mummy";
