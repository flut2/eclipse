...
fn createPipelines() void {
    ...
    const ground_shader = device.createShaderModuleWGSL("Ground shader", @embedFile("../shaders/ground.wgsl"));
    defer ground_shader.release();

    const base_shader = device.createShaderModuleWGSL("Base shader", @embedFile("../shaders/base.wgsl"));
