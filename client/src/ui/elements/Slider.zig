...
pub fn draw(
    ...
    self.decor_image_data.draw(generics, sort_extras, self.base.x + x_offset, self.base.y + y_offset, self.base.scissor);
    ...
    knob_image_data.draw(generics, sort_extras, knob_x, knob_y, self.base.scissor);

    if (self.title_text_data) |*text_data| Renderer.drawText(
        generics,
        sort_extras,
    ...
    if (self.value_text_data) |*text_data| Renderer.drawText(
        generics,
        sort_extras,
