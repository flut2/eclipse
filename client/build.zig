...
pub fn build(b: *std.Build) !void {
    ...
    const dawn_debug_mode = b.option(bool, "dawn_debug_mode", "Whether to have Dawn validation errors and to use the debug binary") orelse false;
    ...
    inline for (.{ true, false }) |check| {
        ...
        @import("zgpu").link("libs/zgpu/", exe, dawn_debug_mode);
        ...
        if (!check) {
            ...
            b.step("run", "Run the Eclipse client").dependOn(&run_cmd.step);
        }
    }
}
