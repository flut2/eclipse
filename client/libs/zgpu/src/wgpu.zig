...
pub const BufferBindingLayout = extern struct {
    ...
    has_dynamic_offset: WGPUBool = .false,
...
pub const BufferDescriptor = extern struct {
    ...
    usage: BufferUsage,
    size: u64,
    mapped_at_creation: WGPUBool = .false,
};
...
pub const ExternalTextureDescriptor = extern struct {
    ...
    do_yuv_to_rgb_conversion_only: WGPUBool,
...
pub const DepthStencilState = extern struct {
    next_in_chain: ?*const ChainedStruct = null,
    format: TextureFormat,
    depth_write_enabled: WGPUBool = .false,
...
pub const MultisampleState = extern struct {
    ...
    alpha_to_coverage_enabled: WGPUBool = .false,
};
...
pub const RequestAdapterOptions = extern struct {
    ...
    compatibility_mode: WGPUBool = .false,
};
...
pub const Adapter = *opaque {
    ...
    pub fn getLimits(adapter: Adapter, limits: *SupportedLimits) WGPUBool {
    ...
    pub fn hasFeature(adapter: Adapter, feature: FeatureName) WGPUBool {
...
pub const Device = *opaque {
    ...
    pub fn getLimits(device: Device, limits: *SupportedLimits) WGPUBool {
    ...
    pub fn hasFeature(device: Device, feature: FeatureName) WGPUBool {
    ...
    pub fn popErrorScope(device: Device, callback: ErrorCallback, userdata: ?*anyopaque) WGPUBool {
        return wgpuDevicePopErrorScope(device, callback, userdata);
    }
    extern fn wgpuDevicePopErrorScope(device: Device, callback: ErrorCallback, userdata: ?*anyopaque) WGPUBool;
